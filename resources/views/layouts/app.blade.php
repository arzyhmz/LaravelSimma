...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('/logo.png') }}" width="50" height="50"
             alt="Simma Logo">
        <img class="navbar-brand-minimized" src="{{ asset('/logo.png') }}" width="50"
             height="50" alt="Simma Logo">
    </a>
...
<footer class="app-footer">
    <div>
        <a href="https://infyom.com">Simma Qontact </a>
        <span>&copy; 2023.</span>
    </div>
    <div class="ml-auto">
